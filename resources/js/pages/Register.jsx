...
export default function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            setError(err.response?.data?.message || 'Registrasi gagal. Coba lagi ya!');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="auth-page">
            ...
            <div className="auth-container">
                ...
                <div className="auth-card">
                    ...
                    <p className="auth-subtitle">Buat akun dan mulai petualangan!</p>
                    ...
                    <form onSubmit={handleRegister}>
                        ...
                        <button type="submit" disabled={loading} className="auth-submit auth-submit-green">
            ...
            <style>{`
                ...
                .auth-field input:focus { border-color: #10B981; background: #fff; box-shadow: 0 0 0 3px rgba(16,185,129,0.15); }
                .auth-submit { width: 100%; padding: 14px; border-radius: 14px; border: none; color: #fff; font-family: 'Nunito', sans-serif; font-weight: 900; font-size: 1rem; cursor: pointer; transition: all 0.2s; margin-top: 4px; }
                .auth-submit-green { background: linear-gradient(135deg, #10B981, #059669); box-shadow: 0 4px 12px rgba(16,185,129,0.35), 0 3px 0 #047857; }
                ...
                .auth-switch a { color: #10B981; font-weight: 800; text-decoration: none; }
